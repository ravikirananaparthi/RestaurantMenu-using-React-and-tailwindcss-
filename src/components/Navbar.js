    ...
    return (
        ...
        <div className='flex items-center'>
            ...
            <h1 className='text-2xl sm:text-3xl lg:text-4xl px-2 '>
                Kelvin <span className='font-bold'>Scale</span>
            </h1>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2
         w-[200px] sm:w-[400px] lg:w-[500px]'>
            ...
            <input className="bg-transparent
             p-2 w-full focus:outline-none" type="text " placeholder="Search Foods"/>
        </div>
        {/* cart button  */}
        ...
        <div className={nav ? 'fixed top-0 left-0 w-300 h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-300 h-screen bg-white z-10 duration-300'}>

        <AiOutlineClose
        onClick={()=>setNav(!nav)} 
        size={30} className='absolute 
        right-4 top-4 cursor-pointer '/>
